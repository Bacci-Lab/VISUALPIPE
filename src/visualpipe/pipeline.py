...
def visual_pipe_shortversion(base_path:str=None, input_gui=False) :
    ...
    # Compute responsive neurons
    trials.find_responsive_rois(save_dir, folder_prefix="_".join([unique_id, id_version]), with_plots=False)
